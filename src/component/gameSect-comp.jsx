...
import { DataGameProject } from '@/data/data-project';

export default function GameSectComp() {
  return (
    <>
      <section className="text-second py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Game Project</h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
              Here are some of the game projects I've worked on. Feel free to explore and check them
              out!
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {DataGameProject.map((item, index) => (
              <div
                key={index}
