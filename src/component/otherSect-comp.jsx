...
import { DataDesignProject } from '@/data/data-project';

export default function OtherSecComp() {
  return (
    <>
      <section className="text-second py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Other Project</h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
              Design, UI/UX Designer, Teaching, and others
            </p>
          </div>

          {/* Grid Cards */}
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {DataDesignProject.map((item, index) => (
              <div
                key={index}
